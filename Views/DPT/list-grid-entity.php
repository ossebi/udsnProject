...
<!-- 
            <div class="header-left border-0 ">
                ...
                <a href="<?= base_url() ?>/index.html" class="logo-small">
            ...
            <ul class="nav user-menu">
                ...
                <li class="nav-item">
                    <div class="top-nav-search">
                        <a href="<?= base_url() ?>/javascript:void(0);" class="responsive-search">
                        ...
                        <ul class=" tabs owl-carousel owl-theme owl-product  border-0 ">
                            <li class="active" id="fruits">
                                <div class="product-details ">
                                    <img src="<?= base_url() ?>/assets/img/product/product62.png" alt="img">
                                    <h6>Fruits</h6>
                                </div>
                            </li>
                            <li id="headphone">
                                <div class="product-details ">
                                    <img src="<?= base_url() ?>/assets/img/product/product63.png" alt="img">
                                    <h6>Headphones</h6>
                                </div>
                            </li>
                            <li id="Accessories">
                                <div class="product-details">
                                    <img src="<?= base_url() ?>/assets/img/product/product64.png" alt="img">
                                    <h6>Accessories</h6>
                                </div>
                            </li>
                            <li id="Shoes">
                                <a class="product-details">
                                    <img src="<?= base_url() ?>/assets/img/product/product65.png" alt="img">
                                    <h6>Shoes</h6>
                                </a>
                            </li>
                            <li id="computer">
                                <a class="product-details">
                                    <img src="<?= base_url() ?>/assets/img/product/product66.png" alt="img">
                                    <h6>Computer</h6>
                                </a>
                            </li>
                            <li id="Snacks">
                                <a class="product-details">
                                    <img src="<?= base_url() ?>/assets/img/product/product67.png" alt="img">
                                    <h6>Snacks</h6>
                                </a>
                            </li>
                            <li id="watch">
                                <a class="product-details">
                                    <img src="<?= base_url() ?>/assets/img/product/product68.png" alt="img">
                                    <h6>Watches</h6>
                                </a>
                            </li>
                            <li id="cycle">
                                <a class="product-details">
                                    <img src="<?= base_url() ?>/assets/img/product/product61.png" alt="img">
                                    <h6>Cycles</h6>
                                </a>
                            </li>
                            <li id="fruits1">
                                ...
                                <div class="row ">
                                    <div class="col-lg-2 col-sm-6 d-flex ">
                                        <div class="productset flex-fill active">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product29.jpg" alt="img">
                                                <h6>Qty: 5.00</h6>
                                    ...
                                    <div class="col-lg-2 col-sm-6 d-flex ">
                                        <div class="productset flex-fill">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product31.jpg" alt="img">
                                                <h6>Qty: 1.00</h6>
                                                <div class="check-product">
                                                    <i class="fa fa-check"></i>
                                                </div>
                                    ...
                                    <div class="col-lg-2 col-sm-6 d-flex ">
                                        <div class="productset flex-fill">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product35.jpg" alt="img">
                                                <h6>Qty: 5.00</h6>
                                                <div class="check-product">
                                                    <i class="fa fa-check"></i>
                                                </div>
                                    ...
                                    <div class="col-lg-2 col-sm-6 d-flex ">
                                        <div class="productset flex-fill">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product37.jpg" alt="img">
                                                <h6>Qty: 5.00</h6>
                                                <div class="check-product">
                                                    <i class="fa fa-check"></i>
                                                </div>
                                    ...
                                    <div class="col-lg-2 col-sm-6 d-flex ">
                                        <div class="productset flex-fill">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product54.jpg" alt="img">
                                                <h6>Qty: 5.00</h6>
                                                <div class="check-product">
                                                    <i class="fa fa-check"></i>
                                                </div>
                            ...
                            <div class="tab_content" data-tab="headphone">
                                <div class="row ">
                                    <div class="col-lg-3 col-sm-6 d-flex ">
                                        <div class="productset flex-fill">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product44.jpg" alt="img">
                                                <h6>Qty: 5.00</h6>
                                                <div class="check-product">
                                                    <i class="fa fa-check"></i>
                                                </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 d-flex ">
                                        <div class="productset flex-fill">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product45.jpg" alt="img">
                                                <h6>Qty: 5.00</h6>
                                                <div class="check-product">
                                                    <i class="fa fa-check"></i>
                                                </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 d-flex ">
                                        <div class="productset flex-fill">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product36.jpg" alt="img">
                                                <h6>Qty: 5.00</h6>
                                                <div class="check-product">
                                                    <i class="fa fa-check"></i>
                                                </div>
                            ...
                            <div class="tab_content" data-tab="Accessories">
                                <div class="row">
                                    <div class="col-lg-3 col-sm-6 d-flex ">
                                        <div class="productset flex-fill">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product32.jpg" alt="img">
                                                <h6>Qty: 1.00</h6>
                                                <div class="check-product">
                                                    <i class="fa fa-check"></i>
                                                </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 d-flex ">
                                        <div class="productset flex-fill">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product46.jpg" alt="img">
                                                <h6>Qty: 1.00</h6>
                                                <div class="check-product">
                                                    <i class="fa fa-check"></i>
                                                </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 d-flex ">
                                        <div class="productset flex-fill">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product55.jpg" alt="img">
                                                <h6>Qty: 1.00</h6>
                                                <div class="check-product">
                                                    <i class="fa fa-check"></i>
                                                </div>
                            ...
                            <div class="tab_content" data-tab="Shoes">
                                <div class="row">
                                    <div class="col-lg-3 col-sm-6 d-flex ">
                                        <div class="productset flex-fill">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product60.jpg" alt="img">
                                                <h6>Qty: 1.00</h6>
                                                <div class="check-product">
                                                    <i class="fa fa-check"></i>
                                                </div>
                            ...
                            <div class="tab_content" data-tab="computer">
                                <div class="row">
                                    <div class="col-lg-3 col-sm-6 d-flex ">
                                        <div class="productset flex-fill">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product56.jpg" alt="img">
                                                <h6>Qty: 1.00</h6>
                                                <div class="check-product">
                                                    <i class="fa fa-check"></i>
                                                </div>
                            ...
                            <div class="tab_content" data-tab="Snacks">
                                <div class="row">
                                    <div class="col-lg-3 col-sm-6 d-flex ">
                                        <div class="productset flex-fill">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product47.jpg" alt="img">
                                                <h6>Qty: 1.00</h6>
                                                <div class="check-product">
                                                    <i class="fa fa-check"></i>
                                                </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 d-flex ">
                                        <div class="productset flex-fill">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product48.png" alt="img">
                                                <h6>Qty: 1.00</h6>
                                                <div class="check-product">
                                                    <i class="fa fa-check"></i>
                                                </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 d-flex ">
                                        <div class="productset flex-fill">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product57.jpg" alt="img">
                                                <h6>Qty: 1.00</h6>
                                                <div class="check-product">
                                                    <i class="fa fa-check"></i>
                                                </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 d-flex ">
                                        <div class="productset flex-fill">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product58.jpg" alt="img">
                                                <h6>Qty: 1.00</h6>
                                                <div class="check-product">
                                                    <i class="fa fa-check"></i>
                                                </div>
                            ...
                            <div class="tab_content" data-tab="watch">
                                <div class="row">
                                    <div class="col-lg-3 col-sm-6 d-flex ">
                                        <div class="productset flex-fill">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product49.jpg" alt="img">
                                                <h6>Qty: 1.00</h6>
                                                <div class="check-product">
                                                    <i class="fa fa-check"></i>
                                                </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 d-flex ">
                                        <div class="productset flex-fill">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product51.jpg" alt="img">
                                                <h6>Qty: 1.00</h6>
                                            </div>
                                            <div class="productsetcontent">
                                                <h4>Watch</h4>
                            ...
                            <div class="tab_content" data-tab="cycle">
                                <div class="row">
                                    <div class="col-lg-3 col-sm-6 d-flex ">
                                        <div class="productset flex-fill">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product52.jpg" alt="img">
                                                <h6>Qty: 1.00</h6>
                                                <div class="check-product">
                                                    <i class="fa fa-check"></i>
                                                </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 d-flex ">
                                        <div class="productset flex-fill">
                                            <div class="productsetimg">
                                                <img src="<?= base_url() ?>/assets/img/product/product53.jpg" alt="img">
                                                <h6>Qty: 1.00</h6>
                                                <div class="check-product">
                                                    <i class="fa fa-check"></i>
                                                </div>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="javascript:void(0);" class="btn btn-closes"><img
                                        src="<?= base_url() ?>/assets/img/icons/close-circle.svg" alt="img"></a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="javascript:void(0);" class="btn btn-reverse"><img
                                        src="<?= base_url() ?>/assets/img/icons/reverse.svg" alt="img"></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="delete-order">
                        <img src="<?= base_url() ?>/assets/img/icons/close-circle1.svg" alt="img">
                    </div>
                                ...
                                <div class="table-top">
                                    <div class="search-set">
                                        <div class="search-input">
                                            <a class="btn btn-searchset"><img src="<?= base_url() ?>/assets/img/icons/search-white.svg"
                                                    alt="img"></a>
                                        </div>
                                    </div>
                                    <div class="wordset">
