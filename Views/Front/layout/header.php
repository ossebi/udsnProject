            ...
            <li class="nav-item dropdown has-arrow main-drop">
                ...
                <div class="dropdown-menu menu-drop-user">
                    <div class="profilename">
                        ...
                        <hr class="m-0">
                        <a class="dropdown-item" href="profile.html"> <i class="me-2" data-feather="user"></i> Mon Compte</a>
                        <a class="dropdown-item" href="generalsettings.html"><i class="me-2"
                                data-feather="settings"></i>Reglages</a>
                        <hr class="m-0">
                        <a class="dropdown-item logout pb-0" href="<?= base_url(route_to('signout'))?>"><img src="<?= base_url('assets/img/icons/log-out.svg') ?>"
                                class="me-2" alt="img">Se déconncter</a>
                    </div>
                </div>
            </li>
        </ul>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    <li>
                        <a href="index.html"><img src="<?= base_url('assets/img/icons/dashboard.svg') ?>" alt="img"><span>
                                Dashboard</span> </a>
                    </li>
                    <li class="submenu">
                        <a href="javascript:void(0);"><img src="<?= base_url('assets/img/icons/product.svg') ?>" alt="img"><span>
                    ...
                    <li class="submenu">
                        <a href="javascript:void(0);"><img src="<?= base_url('assets/img/icons/sales1.svg') ?>" alt="img"><span>
                    ...
                    <li class="submenu">
                        <a href="javascript:void(0);"><img src="<?= base_url('assets/img/icons/purchase1.svg') ?>" alt="img"><span>
                    ...
                    <li class="submenu">
                        <a href="javascript:void(0);"><img src="<?= base_url('assets/img/icons/expense1.svg') ?>" alt="img"><span>
                    ...
                    <li class="submenu">
                        <a href="javascript:void(0);"><img src="<?= base_url('assets/img/icons/quotation1.svg') ?>" alt="img"><span>
                    ...
                    <li class="submenu">
                        <a href="javascript:void(0);"><img src="<?= base_url('assets/img/icons/transfer1.svg') ?>" alt="img"><span>
                    ...
                    <li class="submenu">
                        <a href="javascript:void(0);"><img src="<?= base_url('assets/img/icons/return1.svg') ?>" alt="img"><span>
                    ...
                    <li class="submenu">
                        <a href="javascript:void(0);"><img src="<?= base_url('assets/img/icons/users1.svg') ?>" alt="img"><span>
                    ...
                    <li class="submenu">
                        <a href="javascript:void(0);"><img src="<?= base_url('assets/img/icons/places.svg') ?>" alt="img"><span>
                    ...
                    <li class="submenu">
                        <a href="javascript:void(0);"><img src="<?= base_url('assets/img/icons/time.svg') ?>" alt="img"><span>
                    ...
                    <li class="submenu">
                        <a href="javascript:void(0);"><img src="<?= base_url('assets/img/icons/settings.svg') ?>" alt="img"><span>
