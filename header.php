                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="<?= base_url(route_to('profil_etudiant')) ;?>" class="dropdown-item ai-icon">
                                    ...
                                    <a href="<?= base_url(route_to('sign_out')) ;?>" class="dropdown-item ai-icon">
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="ai-icon" href="<?= base_url(route_to('calendrier_cc')) ;?>" aria-expanded="false">
							<i class="la la-calendar"></i>
							<span class="nav-text">Evénements</span>
						</a>
                    </li>
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
